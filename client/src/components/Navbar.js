...
class Navbar extends Component {
    ...
    handleLogout() {
        this.props.store.alertStore.setLoading(true);
        this.props.store.userStore.logout();
        this.props.store.alertStore.setLoading(false);
        this.props.store.alertStore.setSuccessText("Successfully logged out!");
    }
      ...
      <div id="navbar">
        <div className="nav-container">
          ...
          <ul>
            ...
            { <li onClick={() => !loggedIn ? this.openLoginSignupForm() : this.handleLogout()}><a>{ !loggedIn ? "Sign In" : "Logout" }</a>
